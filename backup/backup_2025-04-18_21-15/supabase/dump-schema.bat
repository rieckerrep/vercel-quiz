...
set BACKUP_DIR=C:\Users\marce\Desktop\RieckerRep React\supabase\sql-base
...
cd /d "C:\Users\marce\Desktop\RieckerRep React\supabase\sql-base"
...
echo ✅ Dump abgeschlossen: %BACKUP_DIR%\schema_.sql
pause
