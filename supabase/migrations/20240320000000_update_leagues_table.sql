...
DROP COLUMN IF EXISTS demotion_threshold;

-- Aktualisiere die bestehenden Ligen mit der korrekten Hierarchie
UPDATE leagues SET
    next_league = CASE 
        WHEN name = 'Holzliga' THEN 'Bronzeliga'
        WHEN name = 'Bronzeliga' THEN 'Silberliga'
        WHEN name = 'Silberliga' THEN 'Goldliga'
        WHEN name = 'Goldliga' THEN 'Platinliga'
        WHEN name = 'Platinliga' THEN 'Champions League'
        ELSE NULL
    END,
    previous_league = CASE 
        WHEN name = 'Champions League' THEN 'Platinliga'
        WHEN name = 'Platinliga' THEN 'Goldliga'
        WHEN name = 'Goldliga' THEN 'Silberliga'
        WHEN name = 'Silberliga' THEN 'Bronzeliga'
        WHEN name = 'Bronzeliga' THEN 'Holzliga'
        ELSE NULL
    END;

-- Aktualisiere die get_league_leaderboard Funktion
