...
CREATE OR REPLACE FUNCTION "public"."get_quiz_summary"("p_user_id" "uuid", "p_chapter_id" integer) RETURNS "json"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_xp INTEGER;
    ...
    v_medals TEXT[];
BEGIN
    SELECT total_xp, total_coins INTO v_xp, v_coins
    FROM user_stats
    WHERE user_id = p_user_id;
    ...
    SELECT ARRAY_AGG(medal_id) INTO v_medals
    FROM user_medals
    WHERE user_id = p_user_id;
...
ALTER FUNCTION "public"."get_quiz_summary"("p_user_id" "uuid", "p_chapter_id" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."submit_answer"("p_user_id" "uuid", "p_question_id" integer, "p_is_correct" boolean) RETURNS "json"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
BEGIN
    ...
    INSERT INTO answered_questions (
        user_id, question_id, is_correct, chapter_id, answered_at
    ) VALUES (
        p_user_id, p_question_id, p_is_correct, v_chapter_id, NOW()
    );

    -- XP berechnen
    v_xp_awarded := calculate_and_award_xp(
        p_user_id,
    ...
    -- Fortschritt eintragen/aktualisieren
...
CREATE OR REPLACE FUNCTION "public"."use_item"("p_user_id" "uuid", "p_item_id" integer) RETURNS boolean
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_available BOOLEAN;
BEGIN
    ...
    IF v_available THEN
        ...
        INSERT INTO item_usage_log (user_id, item_id, used_at)
...
ALTER FUNCTION "public"."use_item"("p_user_id" "uuid", "p_item_id" integer) OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."questions"
    ADD CONSTRAINT "questions_question_type_fkey" FOREIGN KEY ("question_type") REFERENCES "public"."question_types"("id");
...
ALTER TABLE ONLY "public"."user_medals"
    ADD CONSTRAINT "user_medals_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id");
...
GRANT ALL ON FUNCTION "public"."get_quiz_summary"("p_user_id" "uuid", "p_chapter_id" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_quiz_summary"("p_user_id" "uuid", "p_chapter_id" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_quiz_summary"("p_user_id" "uuid", "p_chapter_id" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."use_item"("p_user_id" "uuid", "p_item_id" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."use_item"("p_user_id" "uuid", "p_item_id" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."use_item"("p_user_id" "uuid", "p_item_id" integer) TO "service_role";
