...
CREATE OR REPLACE FUNCTION "public"."calculate_and_award_xp"("p_user_id" "uuid", "p_correct_question_ids" bigint[], "p_correct_subquestion_ids" bigint[]) RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
GRANT ALL ON FUNCTION "public"."calculate_and_award_xp"("p_user_id" "uuid", "p_correct_question_ids" bigint[], "p_correct_subquestion_ids" bigint[]) TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_and_award_xp"("p_user_id" "uuid", "p_correct_question_ids" bigint[], "p_correct_subquestion_ids" bigint[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_and_award_xp"("p_user_id" "uuid", "p_correct_question_ids" bigint[], "p_correct_subquestion_ids" bigint[]) TO "service_role";
